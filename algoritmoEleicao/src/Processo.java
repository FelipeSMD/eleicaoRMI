...
public class Processo implements P, Serializable {
	...
	public static void main(String[] args) throws InterruptedException, AccessException, RemoteException {
		...
		//retira o processo do registro ao encerrar
		Runtime.getRuntime().addShutdownHook(new ShutDown());
		
		//tempo de espera para que outros processos sejam registrados no registro
		Thread.sleep(60000);
		
		//tempo extra aleatorio para que os processos iniciem a primeira eleição em tempos diferentes
		Random rand = new Random();
		int randomNum = rand.nextInt(6) + 1;
		Thread.sleep(randomNum);
		
		//garante que eleições só seram iniciadas após o registro de pelo menos dois processos
	...
	//responde para um processo que iniciou a eleição
	@Override
	...
	//inicia nova elição após constatar que o coordenador caiu
	...
	//checa se o coordenador está vivo
	@Override
	...
	//retira o processo do registro ao ser desligado
